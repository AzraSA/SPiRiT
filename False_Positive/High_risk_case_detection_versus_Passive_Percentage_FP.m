function [Passive_Percetage,Pf_DP_ACT,Pf_AP_DP_3T,Pf_SPiRiT,Pf_DP_3T, high_risk_percentage_AP_DP3T, high_risk_percentage_DP3T, high_risk_percentage_DPACT]=High_risk_case_detection_versus_Passive_Percentage_FP(A2,K,C,Bfa)
% Inputs:
...
% Bfa is the Initial False Alarm
...
for  B=10:10:Bmax
    ...
    for kk=1:K
        ...
        for K1=1:1:ceil(BB)
            ...
            [covid_indexes2]=AP_DP_3T(X_duration_advertize_after_delay,duration_threshold,covid_indexes2,l22,l2,erased_indexes,unerased_indexes);
        ...
        for K1=1:1:ceil(BB)
            ...
            [covid_indexes2f]=AP_DP_3T(X_duration_advertize_after_delay,duration_threshold,covid_indexes2f,l22,l2,erased_indexes,unerased_indexes);
