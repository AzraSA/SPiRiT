function [high_risk_nodes2]=AP_DP_3T_FN(K1,ss2,covid_indexes_initial,X_duration_advertize,duration_threshold,covid_indexes,l22,l2,erased_indexes,unerased_indexes)
high_risk_nodes3=[];
for i=1:l2
