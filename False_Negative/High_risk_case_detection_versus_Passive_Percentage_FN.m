function [Passive_Percetage,high_risk_percentage_SPiRiT,high_risk_percentage_AP_DP_3T,high_risk_percentage_DP_3T,high_risk_percentage_DP_ACT]=High_risk_case_detection_versus_Passive_Percentage_FN(A2,K,C,N_FN)
% Inputs:
...
for  B=10:10:Bmax
    ...
    for kk=1:K
        ...
        ss2=ceil(abs(rand(2*3,ceil(C/100*l2)))*days); %6 days are not revealed by the diagnosed users
    ...
    high_risk_percentage_t(B/10)=high_risk_percentage/high_risk_ref;
